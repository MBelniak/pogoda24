    ...
    private showPicture() {
        ...
        this.props.showModal(
            <div style={{width: "100%", height: "100%", textAlign: "center"}}>
                ...
                <img src={URL.createObjectURL(this.props.file.file)} onClick={() => this.props.closeModal()}/>
            </div>
        )
    }
            ...
            <div className="uploadedFilesItem" onMouseOver={this.displayOverlay} onMouseOut={this.hideOverlay}>
                ...
                <div className="uploadedFilesItemOverlayWrapper" ref={this.overlayDiv} onClick={this.showPicture}>
                    ...
                    <div className="uploadedFilesItemOverlayContent" >
                        <div className="arrowLeft" onClick={(e) => {
                            e.stopPropagation();
                        ...
                        <div className="deleteFile">
                            ...
                            <div className="uploadedFilesItemDelete" onClick={(e) => {
                                    e.stopPropagation();
                                    this.props.onDeleteFile(this.props.file.id);
                                }}/>
                        </div>
                        <div className="arrowRight" onClick={(e) => {
                            e.stopPropagation();
